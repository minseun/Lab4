...
int main(int argc, char *argv[]) {
    ...
    gtk_box_pack_start(GTK_BOX(passwd_hbox), passwd_label, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(passwd_hbox), passwd_entry, TRUE, TRUE, 5);
